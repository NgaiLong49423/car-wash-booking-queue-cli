...
- Sau complete, hệ thống duyệt Waitlist theo thứ tự ưu tiên, bỏ qua tạm thời booking không vừa thời gian và kéo các booking phù hợp lên Main Queue cho đến khi không còn thời gian hoặc booking phù hợp.
...
- Hủy booking trong Main Queue có thể duyệt Waitlist theo ưu tiên để kéo booking phù hợp lên Main Queue.
...
13. Khi Waitlist được kiểm tra theo thời gian còn lại, hệ thống duyệt theo ưu tiên, bỏ qua tạm thời booking không vừa thời gian và tiếp tục xét booking phía sau.
